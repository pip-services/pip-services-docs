...
> constructors(name?: string): [MemoryMessageQueue]()
...
-  **callback**: (`optional`) callback function that receives error or null no errors occured.
...
- refer**ences: [IReferences](../../../commons/refer/ireferences) references to locate the component dependencies.
