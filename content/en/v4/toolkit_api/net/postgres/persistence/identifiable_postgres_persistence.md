...
class MyPostgresPersistence: PostgresPersistence<MyData, string> 
{
    ...
    public Task<MyData> GetPageByFilter(IContext context, FilterParams filter, PagingParams paging)
    {
        return await base.GetPageByFilter(context, this.ComposeFilter(filter), paging, null, null);
    }
}
