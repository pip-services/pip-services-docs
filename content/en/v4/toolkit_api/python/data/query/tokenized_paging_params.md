...
> `static` from_map(map: [AnyValueMap](../../../commons/data/any_value_map)): [TokenizedPagingParams]()

- **map**: [AnyValueMap](../../../commons/data/any_value_map) - a AnyValueMap or StringValueMap to initialize this TokenizedPagingParams
