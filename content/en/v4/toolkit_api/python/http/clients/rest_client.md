...
#### _counters
A list of counters.
> **_counters**: List[[ICounters]ICounters](../../../observability/count/icounters)] = []
...
> **_options**: [ConfigParams](../../../components/config/config_params) = ConfigParams()
...
> _instrument(correlation_id: Optional[str], name: str): [InstrumentTiming](../../../rpc/trace/instrument_timing)
...
- #### [CommandableHttpService](../../controllers/commandable_http_controller)
