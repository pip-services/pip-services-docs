...
> CommandableHttpService(base_route: str, config: [ConfigParams](../../../components/config/config_params), commands: List[[ICommand](../../../rpc/commands/icommand)])

- **base_route**: str - base route of the service
- **config**: [ConfigParams](../../../components/config/config_params) - configuration parameters 
- **commands**: List[[ICommand](../../../rpc/commands/icommand)] - list of commands
