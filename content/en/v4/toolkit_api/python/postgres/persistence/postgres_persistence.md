...
> PostgresPersistence(table_name: str = None, schema_name: str = None)
...
> create(context: Optional[str], item: T): Optional[T]
...
> delete_by_filter(context: Optional[str], filter: Any)
...
- **returns**: [DataPage](../../../data/query/data_page) - data page with filtered result
