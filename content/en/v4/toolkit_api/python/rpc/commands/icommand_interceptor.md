...
> execute(correlation_id: Optional[str], command: [ICommand](../icommand), args: [Parameters](../../../components/exec/parameters)): Any
...
> validate(command: [ICommand](../icommand), args: [Parameters](../../run/parameters)): List[[ValidationResult](../../../data/validate/validation_result)]
